...
public class KindEditorController {
    ...
    public String upload(String title, String content, Integer original, Integer area, HttpServletRequest request) {
//        System.out.println(content);
        //HTML转义
        String content2 = HtmlUtils.htmlEscape(content);
        ...
        url += "/" + filename;
        article.setContent(realPath);

        //存入数据库
        Integer rs = articleService.addArticle(article);
    ...
    public Map<String, Object> fileUpload(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException,
        ...
        String savePath = application.getRealPath("/upload") + "/images/";
    ...
    public void fileManager(HttpServletRequest request,
        ...
        String rootPath = application.getRealPath("/upload") + "images/";
